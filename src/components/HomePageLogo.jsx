...
const HomePageLogo = () => {
  return (
    <section className='text-center h-[274px]'>
      <h1 className='text-4xl mt-10 font-bold text-[#94a684]'>Kan<span className='text-[#ba90c6]'>Ban</span> <span className='text-[#96b6c5]'>Board</span></h1>
      <h1  className='text-4xl mt-10 mb-20 font-bold text-[#94a684] '>Task Management App</h1>
